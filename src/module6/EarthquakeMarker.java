...
public abstract class EarthquakeMarker extends CommonMarker implements Comparable<EarthquakeMarker>
{
	...
	// The radius of the Earthquake marker. You will want to set this in the constructor, either
	...
	// fulfilling Comparable interface contract. Natural order is based on their magnitue.
	...
	public void drawMarker(PGraphics pg, float x, float y) {
		...
		// add X over marker if Earthquake within past day		
	...
	public void showTitle(PGraphics pg, float x, float y)
	{
		...
		int FONT_SIZE = 12;
		int RECT_HEIGHT = FONT_SIZE + 5;
		
		pg.rectMode(PConstants.CORNER);
		
		pg.stroke(110);
		pg.fill(255, 204, 128);
		pg.rect(x, y + 15, pg.textWidth(title) +6, RECT_HEIGHT, 5);
		
		pg.textAlign(PConstants.LEFT, PConstants.TOP);
		pg.fill(0);
		pg.textSize(FONT_SIZE);
		pg.text(title, x + 3 , y +17);
